...
--	FLASH_SCK_O		: out	STD_LOGIC := '0';
	...
	-- ADV7182
	SENS_CLOCK_I	: in	STD_LOGIC;			-- falling edge
	SENS_RESET_O	: out	STD_LOGIC := '0';	-- active low
	SENS_PWRDN_O	: out	STD_LOGIC := '0';	-- active low, pull high after pwrdwn
	SENS_INTRQ_I	: in	STD_LOGIC;			-- active low
	SENS_VSYNC_I	: in	STD_LOGIC;
	SENS_HSYNC_I	: in	STD_LOGIC;
	SENS_DATA_I		: in	STD_LOGIC_VECTOR(7 downto 0);
	
	SENS_SCL_IO 	: inout	STD_LOGIC;
	SENS_SDA_IO 	: inout	STD_LOGIC;
...
architecture toplevel of camera_adv7182 is
...
port map (
	...
	-- 1
	DBG_I(2)	=> SENS_HSYNC_I,
	DBG_I(3)	=> SENS_VSYNC_I,
...
source : entity work.adv7182a
port map (
	RST_I			=> '0',

	-- Sensor Interface
	LLC_I			=> SENS_CLOCK_I,			
	VSYNC_I			=> SENS_VSYNC_I,
	HSYNC_I			=> SENS_HSYNC_I,
	DATA_I			=> SENS_DATA_I,
