...
Port (
	...
	M_AXIS_TDATA_O	: out STD_LOGIC_VECTOR(9 downto 0) := (others => '0');
	M_AXIS_TUSER_O	: out STD_LOGIC_VECTOR(1 downto 0) := (others => '0');
	M_AXIS_TREADY_I	: in  STD_LOGIC	
);
end ev76c560;

architecture Behavioral of ev76c560 is
...
signal data_0		: std_logic_vector(9 downto 0) := (others => '0');
signal data_1		: std_logic_vector(9 downto 0) := (others => '0');
signal fval_edge 	: std_logic_vector(1 downto 0) := "00";
signal lval_edge 	: std_logic_vector(1 downto 0) := "00";

begin

MCLK_O 				<= MCLK_I when MCLK_EN_I = '1' else '0';
