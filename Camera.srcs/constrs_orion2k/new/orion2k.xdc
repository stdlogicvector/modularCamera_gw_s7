...
# Sensor (BANK 34, 3.3V)
# Master Clock
set_property PACKAGE_PIN A4 [get_ports {SENS_MCLKp_O}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_MCLKp_O}]
set_property PACKAGE_PIN A3 [get_ports {SENS_MCLKn_O}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_MCLKn_O}]

# LVAL
set_property PACKAGE_PIN G4 [get_ports {SENS_LVAL_I[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_LVAL_I[0]}]
set_property PACKAGE_PIN P3 [get_ports {SENS_LVAL_I[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_LVAL_I[1]}]

# SPI
set_property PACKAGE_PIN M3 [get_ports {SENS_UPDATE_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_UPDATE_O}]
set_property PACKAGE_PIN J3 [get_ports {SENS_RST_SPI_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_RST_SPI_O}]

set_property PACKAGE_PIN K4 [get_ports {SENS_CS_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_CS_O}]
set_property PACKAGE_PIN M2 [get_ports {SENS_SCK_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_SCK_O}]
set_property PACKAGE_PIN J4 [get_ports {SENS_MOSI_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_MOSI_O}]
set_property PACKAGE_PIN K3 [get_ports {SENS_MISO_I}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_MISO_I}]

# Reset
set_property PACKAGE_PIN C5 [get_ports {SENS_RST_PLL_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_RST_PLL_O}]
set_property PACKAGE_PIN C4 [get_ports {SENS_RST_LOGIC_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_RST_LOGIC_O}]

# Control
set_property PACKAGE_PIN D4 [get_ports {SENS_READOUT_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_READOUT_O}]
set_property PACKAGE_PIN E4 [get_ports {SENS_ADCONV_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_ADCONV_O}]
set_property PACKAGE_PIN F2 [get_ports {SENS_SAMPLE_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_SAMPLE_O}]
set_property PACKAGE_PIN F3 [get_ports {SENS_RST_CDS_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_RST_CDS_O}]
set_property PACKAGE_PIN F4 [get_ports {SENS_RST_CVC_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_RST_CVC_O}]

set_property PACKAGE_PIN P4 [get_ports {SENS_EXT_SYNC_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_EXT_SYNC_O}]

# Data Clock (Inverted)
set_property PACKAGE_PIN H4 [get_ports {SENS_DCLKp_I}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DCLKp_I}]
set_property PACKAGE_PIN H3 [get_ports {SENS_DCLKn_I}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DCLKn_I}]

# Data Seg 1 LSB A (Inverted)
set_property PACKAGE_PIN B2 [get_ports {SENS_DATAp_I[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAp_I[0]}]
set_property PACKAGE_PIN B1 [get_ports {SENS_DATAn_I[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAn_I[0]}]

# Data Seg 1 MSB A (Inverted)
set_property PACKAGE_PIN D1 [get_ports {SENS_DATAp_I[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAp_I[1]}]
set_property PACKAGE_PIN C1 [get_ports {SENS_DATAn_I[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAn_I[1]}]

# Data Seg 1 LSB B (Inverted)
set_property PACKAGE_PIN E2 [get_ports {SENS_DATAp_I[2]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAp_I[2]}]
set_property PACKAGE_PIN D2 [get_ports {SENS_DATAn_I[2]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAn_I[2]}]

# Data Seg 1 MSB B
set_property PACKAGE_PIN G1 [get_ports {SENS_DATAp_I[3]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAp_I[3]}]
set_property PACKAGE_PIN F1 [get_ports {SENS_DATAn_I[3]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAn_I[3]}]

# Data Seg 2 LSB A (Inverted)
set_property PACKAGE_PIN J2 [get_ports {SENS_DATAp_I[4]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAp_I[4]}]
set_property PACKAGE_PIN J1 [get_ports {SENS_DATAn_I[4]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAn_I[4]}]

# Data Seg 2 MSB A (Inverted)
set_property PACKAGE_PIN M1 [get_ports {SENS_DATAp_I[5]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAp_I[5]}]
set_property PACKAGE_PIN L1 [get_ports {SENS_DATAn_I[5]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAn_I[5]}]

# Data Seg 2 LSB B (Inverted)
set_property PACKAGE_PIN L3 [get_ports {SENS_DATAp_I[6]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAp_I[6]}]
set_property PACKAGE_PIN L2 [get_ports {SENS_DATAn_I[6]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAn_I[6]}]

# Data Seg 2 MSB B
set_property PACKAGE_PIN P2 [get_ports {SENS_DATAp_I[7]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAp_I[7]}]
set_property PACKAGE_PIN N1 [get_ports {SENS_DATAn_I[7]}]
set_property IOSTANDARD LVDS_25 [get_ports {SENS_DATAn_I[7]}]