...
# Sensor (BANK 34, 3.3V)
set_property PACKAGE_PIN A3 [get_ports {SENS_CTL_O[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CTL_O[0]}]
set_property PACKAGE_PIN B3 [get_ports {SENS_CTL_O[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CTL_O[1]}]
set_property PACKAGE_PIN A4 [get_ports {SENS_CTL_O[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CTL_O[2]}]
set_property PACKAGE_PIN B6 [get_ports {SENS_CTL_O[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CTL_O[3]}]
set_property PACKAGE_PIN C3 [get_ports {SENS_CTL_O[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CTL_O[4]}]
set_property PACKAGE_PIN A2 [get_ports {SENS_CTL_O[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CTL_O[5]}]

set_property PACKAGE_PIN D4 [get_ports {SENS_CS_O[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CS_O[0]}]
set_property PACKAGE_PIN C5 [get_ports {SENS_SCK_O[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SCK_O[0]}]
set_property PACKAGE_PIN C4 [get_ports {SENS_SDO_I[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SDO_I[0]}]

set_property PACKAGE_PIN F4 [get_ports {SENS_CS_O[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CS_O[1]}]
set_property PACKAGE_PIN F3 [get_ports {SENS_SCK_O[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SCK_O[1]}]
set_property PACKAGE_PIN F2 [get_ports {SENS_SDO_I[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SDO_I[1]}]

set_property PACKAGE_PIN K3 [get_ports {SENS_CS_O[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CS_O[2]}]
set_property PACKAGE_PIN J4 [get_ports {SENS_SCK_O[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SCK_O[2]}]
set_property PACKAGE_PIN J3 [get_ports {SENS_SDO_I[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SDO_I[2]}]