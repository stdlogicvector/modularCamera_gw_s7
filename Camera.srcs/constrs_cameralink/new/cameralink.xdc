...
# Cameralink (BANK 34, 3.3V)
# Clock (Inverted)
set_property PACKAGE_PIN G4 [get_ports {XCLKp_I}]
set_property IOSTANDARD LVDS_25 [get_ports {XCLKp_I}]
set_property PACKAGE_PIN G4 [get_ports {XCLKp_I}]
set_property IOSTANDARD LVDS_25 [get_ports {XCLKp_I}]

# Data 0 (Inverted)
set_property PACKAGE_PIN E2 [get_ports {Xp_I[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {Xp_I[0]}]
set_property PACKAGE_PIN D2 [get_ports {Xn_I[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {Xn_I[0]}]

# Data 1 (Inverted)
set_property PACKAGE_PIN F3 [get_ports {Xp_I[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {Xp_I[1]}]
set_property PACKAGE_PIN F2 [get_ports {Xn_I[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {Xn_I[1]}]

# Data 2 (Inverted)
set_property PACKAGE_PIN G1 [get_ports {Xp_I[2]}]
set_property IOSTANDARD LVDS_25 [get_ports {Xp_I[2]}]
set_property PACKAGE_PIN F1 [get_ports {Xn_I[2]}]
set_property IOSTANDARD LVDS_25 [get_ports {Xn_I[2]}]

# Data 3 (Inverted)
set_property PACKAGE_PIN H4 [get_ports {Xp_I[3]}]
set_property IOSTANDARD LVDS_25 [get_ports {Xp_I[3]}]
set_property PACKAGE_PIN H3 [get_ports {Xn_I[3]}]
set_property IOSTANDARD LVDS_25 [get_ports {Xn_I[3]}]

# CC 0 (Inverted)
set_property PACKAGE_PIN K4 [get_ports {CCp_O[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {CCp_O[0]}]
set_property PACKAGE_PIN K3 [get_ports {CCn_O[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {CCn_O[0]}]

# CC 1
set_property PACKAGE_PIN M1 [get_ports {CCp_O[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {CCp_O[1]}]
set_property PACKAGE_PIN L1 [get_ports {CCn_O[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {CCn_O[1]}]

# CC 2 (Inverted)
set_property PACKAGE_PIN M3 [get_ports {CCp_O[2]}]
set_property IOSTANDARD LVDS_25 [get_ports {CCp_O[2]}]
set_property PACKAGE_PIN M2 [get_ports {CCn_O[2]}]
set_property IOSTANDARD LVDS_25 [get_ports {CCn_O[2]}]

# CC 3
set_property PACKAGE_PIN L3 [get_ports {CCp_O[3]}]
set_property IOSTANDARD LVDS_25 [get_ports {CCp_O[3]}]
set_property PACKAGE_PIN L2 [get_ports {CCn_O[3]}]
set_property IOSTANDARD LVDS_25 [get_ports {CCn_O[3]}]

# Serial to Framegrabber (Inverted)
set_property PACKAGE_PIN J2 [get_ports {SERTFGp_I}]
set_property IOSTANDARD LVDS_25 [get_ports {SERTFGp_I}]
set_property PACKAGE_PIN J1 [get_ports {SERTFGn_I}]
set_property IOSTANDARD LVDS_25 [get_ports {SERTFGn_I}]

# Serial to Camera
set_property PACKAGE_PIN J4 [get_ports {SERTCp_O}]
set_property IOSTANDARD LVDS_25 [get_ports {SERTCp_O}]
set_property PACKAGE_PIN J3 [get_ports {SERTCn_O}]
set_property IOSTANDARD LVDS_25 [get_ports {SERTCn_O}]