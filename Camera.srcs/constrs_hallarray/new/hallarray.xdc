...
# Hall Sensor Array (BANK 34, 3.3V)
# Enable
set_property PACKAGE_PIN A5 [get_ports {SENS_nENABLE_O}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_nENABLE_O}]

# Row
set_property PACKAGE_PIN D4 [get_ports {SENS_ROW_O[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_ROW_O[0]}]
set_property PACKAGE_PIN E4 [get_ports {SENS_ROW_O[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_ROW_O[1]}]
set_property PACKAGE_PIN F2 [get_ports {SENS_ROW_O[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_ROW_O[2]}]

# Col
set_property PACKAGE_PIN A4 [get_ports {SENS_COL_O[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_COL_O[0]}]
set_property PACKAGE_PIN A3 [get_ports {SENS_COL_O[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_COL_O[1]}]
set_property PACKAGE_PIN B3 [get_ports {SENS_COL_O[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_COL_O[2]}]

# ADC
set_property PACKAGE_PIN M3 [get_ports {SENS_nCS_O}]
...
set_property PACKAGE_PIN K4 [get_ports {SENS_SDO_I}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SDO_I}]
