...
# Microphone Array (BANK 34, 3.3V)
set_property PACKAGE_PIN M2 [get_ports {SENS_WCLK_O[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_WCLK_O[0]}]
set_property PACKAGE_PIN K4 [get_ports {SENS_SCK_O[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SCK_O[0]}]
set_property PACKAGE_PIN K3 [get_ports {SENS_SDO_I[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SDO_I[0]}]

set_property PACKAGE_PIN P4 [get_ports {SENS_WCLK_O[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_WCLK_O[1]}]
set_property PACKAGE_PIN P3 [get_ports {SENS_SCK_O[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SCK_O[1]}]
set_property PACKAGE_PIN M3 [get_ports {SENS_SDO_I[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SDO_I[1]}]

set_property PACKAGE_PIN F3 [get_ports {SENS_WCLK_O[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_WCLK_O[2]}]
set_property PACKAGE_PIN F4 [get_ports {SENS_SCK_O[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SCK_O[2]}]
set_property PACKAGE_PIN G4 [get_ports {SENS_SDO_I[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SDO_I[2]}]

set_property PACKAGE_PIN B5 [get_ports {SENS_WCLK_O[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_WCLK_O[3]}]
set_property PACKAGE_PIN C4 [get_ports {SENS_SCK_O[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SCK_O[3]}]
set_property PACKAGE_PIN C5 [get_ports {SENS_SDO_I[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SDO_I[3]}]
