...
# MT9P031 Sensor (BANK 34, 2.5V)
# Master Clock
set_property PACKAGE_PIN B5 [get_ports {SENS_CLK_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_CLK_O}]

# Sync
set_property PACKAGE_PIN P3 [get_ports {SENS_LVAL_I}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_LVAL_I}]
set_property PACKAGE_PIN M3 [get_ports {SENS_FVAL_I}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_FVAL_I}]

# I2C
set_property PACKAGE_PIN K4 [get_ports {SENS_SCL_IO}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_SCL_IO}]
set_property PACKAGE_PIN M2 [get_ports {SENS_SDA_IO}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_SDA_IO}]

# Reset
set_property PACKAGE_PIN B3 [get_ports {SENS_nRESET_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_nRESET_O}]

# Control
set_property PACKAGE_PIN A5 [get_ports {SENS_OE_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_OE_O}]
set_property PACKAGE_PIN A3 [get_ports {SENS_TRIGGER_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_TRIGGER_O}]
set_property PACKAGE_PIN P4 [get_ports {SENS_STROBE_I}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_STROBE_I}]
set_property PACKAGE_PIN A4 [get_ports {SENS_nSTANDBY_O}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_nSTANDBY_O}]

# Pixel Clock (CLK and D0 were switched on PCBv1 -> bodged)
set_property PACKAGE_PIN D1 [get_ports {SENS_PCLK_I}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_PCLK_I}]

# Pixel Data
set_property PACKAGE_PIN C1 [get_ports {SENS_DATA_I[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[0]}]
set_property PACKAGE_PIN D2 [get_ports {SENS_DATA_I[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[1]}]
set_property PACKAGE_PIN E2 [get_ports {SENS_DATA_I[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[2]}]
set_property PACKAGE_PIN F1 [get_ports {SENS_DATA_I[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[3]}]
set_property PACKAGE_PIN G1 [get_ports {SENS_DATA_I[4]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[4]}]
set_property PACKAGE_PIN H3 [get_ports {SENS_DATA_I[5]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[5]}]
set_property PACKAGE_PIN H4 [get_ports {SENS_DATA_I[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[6]}]
set_property PACKAGE_PIN J1 [get_ports {SENS_DATA_I[7]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[7]}]
set_property PACKAGE_PIN J2 [get_ports {SENS_DATA_I[8]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[8]}]
set_property PACKAGE_PIN L1 [get_ports {SENS_DATA_I[9]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[9]}]
set_property PACKAGE_PIN M1 [get_ports {SENS_DATA_I[10]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[10]}]
set_property PACKAGE_PIN L2 [get_ports {SENS_DATA_I[11]}]
set_property IOSTANDARD LVCMOS25 [get_ports {SENS_DATA_I[11]}]
