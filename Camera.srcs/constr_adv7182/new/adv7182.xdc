...
# Clock
set_property PACKAGE_PIN D1 [get_ports {SENS_CLOCK_I}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_CLOCK_I}]

# SYNC
set_property PACKAGE_PIN B2 [get_ports {SENS_HSYNC_I}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_HSYNC_I}]
set_property PACKAGE_PIN B1 [get_ports {SENS_VSYNC_I}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_VSYNC_I}]

# I2C
set_property PACKAGE_PIN B3 [get_ports {SENS_SCL_IO}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SCL_IO}]
set_property PULLUP TRUE [get_ports {SENS_SCL_IO}]
set_property PACKAGE_PIN A3 [get_ports {SENS_SDA_IO}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_SDA_IO}]
set_property PULLUP TRUE [get_ports {SENS_SDA_IO}]

# Misc
set_property PACKAGE_PIN A4 [get_ports {SENS_INTRQ_I}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_INTRQ_I}]
set_property PACKAGE_PIN A5 [get_ports {SENS_RESET_O}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_RESET_O}]
set_property PACKAGE_PIN B5 [get_ports {SENS_PWRDN_O}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_PWRDN_O}]

# Data
set_property PACKAGE_PIN M1 [get_ports {SENS_DATA_I[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_DATA_I[0]}]
set_property PACKAGE_PIN L1 [get_ports {SENS_DATA_I[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_DATA_I[1]}]
set_property PACKAGE_PIN J2 [get_ports {SENS_DATA_I[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_DATA_I[2]}]
set_property PACKAGE_PIN J1 [get_ports {SENS_DATA_I[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_DATA_I[3]}]
set_property PACKAGE_PIN H4 [get_ports {SENS_DATA_I[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_DATA_I[4]}]
set_property PACKAGE_PIN H3 [get_ports {SENS_DATA_I[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_DATA_I[5]}]
set_property PACKAGE_PIN G1 [get_ports {SENS_DATA_I[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_DATA_I[6]}]
set_property PACKAGE_PIN F1 [get_ports {SENS_DATA_I[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENS_DATA_I[7]}]
